...
font-optical-sizing: inherit; font-kerning: inherit; font-variation-settings: inherit;" href="https://medium.com/m/global-identity-2?redirectUrl=https://threshold.games/assets/" data-linkindex="0" data-auth="NotApplicable">View Statement</a></div>
